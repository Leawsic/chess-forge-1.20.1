...
public final class ChessNetwork {
    ...
    public static void init() {
        ...
        register(CycleAiDifficultyPacket.class, CycleAiDifficultyPacket::encode, CycleAiDifficultyPacket::decode, CycleAiDifficultyPacket::handle);
